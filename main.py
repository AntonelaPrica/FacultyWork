...
def print_menu():
    ...
    print("8. RG -> FA")
    print("9. FA -> RG")
    print("10. Print FIRST")
    print("11. Parse given sequence")
    print("12. Parse given PIF")
...
def main():
    ...
    while True:
        ...
        if inp == 0:
            ...
            grammar = Grammar.read_file("grammarLab1.0.txt")
        elif inp == 2:
            ...
            print(grammar.get_first_table())
        elif inp == 11:
            word = input("Give a sequence for the grammar: ")  # a*(a+a) the sequence from seminar
            grammar = Grammar.read_file("grammar2.txt")
            parser = Parser(grammar, word)
            print(parser.parseSequence())
        elif inp == 12:
            grammar = Grammar.read_file("grammarLab1.0.txt")
            parser = Parser(grammar, '')
            print(parser.parseByPIF())
        else:
            print("Invalid input!")
